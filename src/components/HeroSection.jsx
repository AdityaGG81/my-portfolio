  ...
  return (
    <div className="w-full px-1 sm:px-2 pt-8 pb-2">
      <section
        ...
        aria-label="Aditya Ghorpade — Full Stack Engineer"
      >
        ...
        <div className="relative grid gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-center">
          <div className="flex flex-col gap-6 lg:gap-8">
            ...
            <p className="max-w-xl font-['Gilroy'] text-lg leading-relaxed text-[hsl(var(--muted-foreground))] sm:text-xl">
              ...
              <span className="text-[hsl(var(--ink))]">Next.js</span>, <span className="text-[hsl(var(--ink))]">Node.js</span>, Laravel, and cloud infrastructure. Experienced in AI integrations, automation, and scalable backend systems.
            </p>

            <div className="flex flex-col items-stretch gap-3 pt-2 sm:flex-row sm:flex-wrap sm:items-center">
              <a
                href="https://drive.google.com/file/d/1TpitSibz8MccELFnn2Y9z1vUJNOxvPz7/view?usp=sharing"
                target="_blank"
          ...
          <div className="relative mx-auto flex w-full max-w-[280px] flex-col items-center lg:max-w-none">
            <div className="relative min-h-[260px] min-w-[260px] sm:min-h-[280px] sm:min-w-[280px]">
              ...
              {/* Sticker over the profile picture */}
              <div className="absolute -bottom-4 -right-4 z-10 -rotate-2 rounded-xl border-2 border-[hsl(var(--ink))] bg-[hsl(var(--surface))] px-4 py-3 font-mono text-[10px] font-bold uppercase leading-tight tracking-wider text-[hsl(var(--ink))] shadow-[4px_4px_0_hsl(var(--signal)/0.25)] sm:-bottom-2 sm:-right-2 sm:text-xs">
                OPEN TO INTERESTING<br />INFRA PROBLEMS
              </div>
            </div>
          </div>
        </div>
